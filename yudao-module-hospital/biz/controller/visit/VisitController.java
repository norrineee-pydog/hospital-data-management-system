...
public class VisitController {
    ...
    @PreAuthorize("@ss.hasPermission('hospital:visit:cancel')")
    public CommonResult<Boolean> cancelAppointment(@RequestParam("id") Integer id) {
        visitService.cancelAppointment(id);
        return success(true);
    }
