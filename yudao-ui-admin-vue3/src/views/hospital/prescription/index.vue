<template>
  <div class="p-20px">
    ...
    <el-table v-loading="loading" :data="list" border stripe>
      ...
      <!-- 1. 修改：将“就诊ID”列改为显示“患者姓名” -->
      <!-- 注意：如果后端返回了 patientName，这里直接绑定 prop="patientName" -->
      <el-table-column label="患者姓名" prop="patientName" width="120" />

      <!-- 2. 修改：将原来的“医生ID”列改为显示“医生姓名” -->
      <el-table-column label="医生姓名" prop="doctorName" width="120" />

      <!-- 保留就诊ID（可选）：如果你还需要看就诊ID，可以保留这一列，或者把它移到后面 -->
      <el-table-column label="就诊ID" prop="visitId" width="100" />
